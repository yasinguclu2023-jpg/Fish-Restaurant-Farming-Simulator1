...
namespace OutlineFx
{
    public partial class OutlineFxFeature : ScriptableRendererFeature
    {
        ...
        // entries for child renderers (no Outline component on the child itself)
        internal struct RenderEntryData
        {
            public Renderer renderer;
            public Color color;
        }
        private static List<RenderEntryData> _renderEntries = new List<RenderEntryData>();
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
        {
            ...
            if (_renderers.Count == 0 && _renderEntries.Count == 0)
                return;
        ...
        public static void RenderEntry(Renderer renderer, Color color)
        {
            _renderEntries.Add(new RenderEntryData { renderer = renderer, color = color });
        }
